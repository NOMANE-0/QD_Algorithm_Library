...
又称 rv ，是一套经典的代表性开源，以 ROS2 为框架，代码结构简单易上手，但是瞄准决策交给了电控

华南师范大学-PIONEER-陈君（又称君佬）-22赛季开源

> 适合学习自瞄，但在现在并不是部署的最优选
...
将 EKF 的观测量从 xyza / ypda 改成成了基于像素坐标系下的像素点为观测量
...
> 据群友反应收敛效果极好，10m 6mm 打前哨，舍弃了 solvepnp 
...
### [AT_NN_Detector](https://github.com/PraySky1337/AT_NN_Detector)
...
[bevy_robomaster_simulator](https://github.com/Blackjack200/bevy_robomaster_simulator)  河北科大自瞄仿真器